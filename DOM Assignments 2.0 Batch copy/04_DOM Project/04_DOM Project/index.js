...
var firstChild = parent_element.querySelector(".one-third");
firstChild.style.color = "white";

var secondChild = parent_element.querySelector(".one-third:nth-child(2)");
secondChild.style.color = "white";

var thirdChild = parent_element.querySelector(".one-third:nth-child(3)");
thirdChild.style.color = "white";

// ---------------------------------------------------------------------------------------------------------

var parentElement = document.querySelector(".clash-card__unit-stats--giant");
parentElement.style.backgroundColor = "#ff9966";

var firstChild = parentElement.querySelector(".one-third");
firstChild.style.color = "white";
