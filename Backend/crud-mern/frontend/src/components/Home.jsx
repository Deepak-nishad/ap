        ...
        <div className="row">
          <div className="col-md-12">
            <div className="d-flex align-items-center justify-content-between">
              ...
              <button className="btn btn-primary mx-1" onClick={() => navigate(`/add`)}>
                <MdPersonAdd />
              </button>
            </div>
            {/* Table Code Start */}
                ...
                {data.map((item, id) => {
                  return (
                    <tr key={id}>
                      ...
                      <td>{item.city}</td>
                      <td>
                        <button className="btn btn-primary mx-1" onClick={() => viewUser(item._id)}><FaEye /></button>
                        <button className="btn btn-warning mx-1" onClick={() => editUser(item._id)}><FaUserEdit /></button>
                        <button className="btn btn-danger mx-1" onClick={() => deleteUser(item._id)}><MdDeleteForever /></button>
                      </td>
                    </tr>
                  );
                })}
